...
-- MySQL INSERT SP : ABC_JOB_MST --

-- drop procedure insert_job_from_json;
...
-- drop procedure update_job_from_json;
...
-- drop procedure delete_job_from_json;
...
-- drop procedure insert_workflow_from_json;
...
-- drop procedure update_workflow_from_json;
...
-- drop procedure delete_workflow_from_json;
...
-- drop procedure insert_workflow_job_relation_from_json;
...
-- drop procedure update_workflow_job_relation_from_json;
...
-- drop procedure delete_workflow_job_relation_from_json;
...
-- drop procedure insert_subjectarea_from_json;
...
-- drop procedure update_subjectarea_from_json;
...
-- drop procedure delete_subjectarea_from_json;
